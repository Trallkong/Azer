...
use crate::renderer::vertex::{get_ibo_2d, get_vbo_from_size, Vertex2D};
use std::sync::Arc;
...
impl RenderRectangle {
    pub fn new(
        ...
        let vbo = get_vbo_from_size((1,1), allocators.buffer_allocator.clone());
        let indices = [0, 1, 2, 2, 3, 0];
        let ibo = get_ibo_2d(indices.into(), allocators.buffer_allocator.clone());
        ...
        Self { vbo, ibo, set1, set2 ,pipeline_layout }
    }
